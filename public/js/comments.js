			...
			let comment=data.comment;
				            ...
				            <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
				              ...
				              <ul class="list-inline d-sm-flex my-0">
				                <li class="list-inline-item ml-auto">
				                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover displayReply" href="#" onclick=" displayReplyForm(${comment.id})" >
				...
				<div style="margin:10px 0;margin-left: 65px;" class="ReplyForm displayForm" id="${comment.id}">   
							<form  action="#" >
								...
								<button  type="button" class="replybtn" onclick="commentReply()" > <i class="reply fa fa-paper-plane" aria-hidden="true" style="color: #f51167;"></i></button>
								</div>
							</form>
						</div>   
					</div>
